...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'playto'),
        'USER': os.getenv('DB_USER', 'playto'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'playto'),
...
# Money handling — defensive default for idempotency expiry
